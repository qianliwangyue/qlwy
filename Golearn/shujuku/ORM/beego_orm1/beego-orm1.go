...
func init() {
	...
	orm.RegisterDataBase("default", "mysql", "root:19992018470.Zd@tcp(127.0.0.1:3306)/student?charset=utf8")
	// 需要在init中注册定义的model
	orm.RegisterModel(new(BeegoUser)) //注册数据库表模型
}
...
func main() {
	...
	o := orm.NewOrm()
	o.Using("student") // 默认使用 default，你可以指定为其他数据库
//	user1 := new(BeegoUser)
/*	user.Name = "Shirdon2"
